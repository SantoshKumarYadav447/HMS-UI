...
const DoctorRegister = () => {
  ...
  return (
    <>
      <div className="row login-row  my-bg-color1 d-flex justify-content-center align-items-center vh-100">
        <div className="col-md-5 mx-auto my-bg-color2 text-light my-5 rounded-3 p-5">
          <h2 className='my-color3 mb-4 fw-bold text-light  text-center'>Doctor Register</h2>
          <form  onSubmit={handleSubmit((d) => console.log(d))}>
            <div className="row">
            <div className='col-md-6 mb-4'>
              <input {...register("name")} className='myform-control form-control ps-0 text-dark rounded-0 mt-1' placeholder='Enter your name' type="text" id="name" />
              {errors.name && <div className="text-danger fw-bold">{errors.name?.message}</div>}
            </div>
            
            <div className='col-md-6 mb-4'>
              <select {...register("departmentId")} className='myform-control text-light form-control ps-0 text-dark rounded-0 mt-1'>
            ...
            <div className='col-md-6 mb-4'>
              <input {...register("specialist")} className='myform-control form-control ps-0 text-dark rounded-0 mt-1' placeholder='Enter your specialist' type="text" id="specialist" />
              {errors.specialist && <div className="text-danger fw-bold">{errors.specialist?.message}</div>}
            </div>

            <div className='col-md-6 mb-4'>
              <input {...register("qualifications")} className='myform-control form-control ps-0 text-dark rounded-0 mt-1' placeholder='Enter your qualifications' type="text" id="qualifications" />
              {errors.qualifications && <div className="text-danger fw-bold">{errors.qualifications?.message}</div>}
            </div>

            <div className='col-md-6 mb-4'>
              <input {...register("contact")} className='myform-control form-control ps-0 text-dark rounded-0 mt-1' placeholder='Enter your contact number' type="text" id="contact" />
              {errors.contact && <div className="text-danger fw-bold">{errors.contact?.message}</div>}
            </div>

            <div className='col-md-6 mb-4'>
              <input {...register("experience")} className='myform-control form-control ps-0 text-dark rounded-0 mt-1' placeholder='Enter your experience (years)' type="number" id="experience" />
              {errors.experience && <div className="text-danger fw-bold">{errors.experience?.message}</div>}
            </div>

            <div className='col-md-6 mb-4'>
              <input {...register("fees")} className='myform-control form-control ps-0 text-dark rounded-0 mt-1' placeholder='Enter your fees' type="number" id="fees" />
              {errors.fees && <div className="text-danger fw-bold">{errors.fees?.message}</div>}
            </div>

            <div className='col-md-6 mb-4'>
              <input {...register("address")} className='myform-control form-control ps-0 text-dark rounded-0 mt-1' placeholder='Enter your address' type="text" id="address" />
              {errors.address && <div className="text-danger fw-bold">{errors.address?.message}</div>}
            </div>

            <div className='col-md-6 mb-4'>
              <input {...register("email")} className='myform-control form-control ps-0 text-dark rounded-0 mt-1' placeholder='Enter your email' type="text" id="email" />
              {errors.email && <div className="text-danger fw-bold">{errors.email?.message}</div>}
            </div>

            <div className='col-md-6 mb-4'>
              <input {...register("profile")} className='myform-control form-control ps-0 text-dark rounded-0 mt-1' type="file" id="profile" />
